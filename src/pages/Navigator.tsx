  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', position: 'relative' }}>
      ...
      >
        ...
        {/* Zoom buttons (right side, easy thumb reach) */}
      ...
      {/* ── Bottom toolbar (iPad thumb-friendly) ── */}
      <div style={{ background: '#0F172A', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', paddingBottom: 'max(10px, env(safe-area-inset-bottom))' }}>
        ...
        {/* Georef missing */}
        {!georef && (
          <button onClick={() => onGeoref(chart)} style={S.bottomBtn('#451A03', '#FB923C')}>
